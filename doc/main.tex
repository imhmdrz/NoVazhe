...
\include{chapters/background}        % فصل دوم: مفاهیم پایه
\include{chapters/technical_guide}   % فصل سوم: راهنمای فنی
\include{chapters/user_guide}        % فصل چهارم: راهنمای کاربر
\include{chapters/conclusion}        % فصل پنجم: جمع‌بندی و کارهای آینده
...
\bibliography{NovazhehReferences}
}
