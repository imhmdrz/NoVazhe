...
fun AuthScreen(navController: NavController, viewModel: AuthViewModel) {
    ...
    // Drives the one-shot "assemble in" entrance: title drops in first, then the form.
    ...
    CompositionLocalProvider(LocalLayoutDirection provides LayoutDirection.Rtl) {
        Box(
            ...
            Column(
                ...
                // Form fields — slide up + fade in slightly after the title.
                AnimatedVisibility(
                    visible = visible,
                    enter = fadeIn(tween(450, delayMillis = 120)) +
                            slideInVertically(tween(450, delayMillis = 120)) { it / 4 }
                ) {
